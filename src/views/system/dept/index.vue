<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="deptStatus" label="状态" :formatter="statusFormatter" width="100" />
    ...
    <!-- 添加或修改部门对话框 -->
    <el-dialog :title="title" :visible.sync="deptDialogVisible" width="600px" :before-close="deptDialogHandleClose">
