<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="优惠金额" prop="coupon" />
        <el-table-column label="最少消费金额" prop="sum" width="120"/>
        <el-table-column label="领取限制数量" prop="limit" width="120"/>
        ...
        <el-table-column label="优惠券简介" prop="remark"  width="120"/>
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-form-item label="优惠金额" prop="coupon">
            <el-input-number v-model="form.coupon" controls-position="right" :min="0" :precision="2" :step="1"/>
          </el-form-item>
          <el-form-item label="最少消费金额" prop="sum">
            <el-input-number v-model="form.sum" controls-position="right" :min="0" :precision="2" :step="1"/>
          </el-form-item>
          <el-form-item label="领取限制数量" prop="limit">
            <el-input-number v-model="form.limit" controls-position="right" :min="0"/>
          </el-form-item>
          <el-form-item label="状态" prop="status">
      ...
      placeholder="选择日期">
          ...
          <el-form-item label="优惠券简介" prop="remark">
